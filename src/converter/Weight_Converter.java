...
public class Weight_Converter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ton - طن", "kg - كيلو جرام", "g - جرام", "mg - ملي جرام", "µg - ميكرو جرام ", "ng - نانو جرام", "pg - بيكو جرام", "lb - بوند" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ton - طن", "kg - كيلو جرام", "g - جرام", "mg - ملي جرام", "µg - ميكرو جرام ", "ng - نانو جرام", "pg - بيكو جرام", "lb - بوند" }));
    ...
    if(from_type.equals("ton - طن") ){
        if(to_type.equals("ton - طن")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
         }
        else if(to_type.equals("kg - كيلو جرام")){
             num1= Double.parseDouble(txtAll.getText());
             result = num1 * 1000;
             resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("g - جرام")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 1000000;
              resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("mg - ملي جرام")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 1000000000;
              resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("µg - ميكرو جرام ")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 1000000000;
              result = result * 1000;
              resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("ng - نانو جرام")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 1000000000;
              result = result * 1000000;
              resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("pg - بيكو جرام")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 907184740;
              result = result * 1000000000;
              resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("lb - بوند")){
              num1= Double.parseDouble(txtAll.getText());
              result = num1 * 2204.62;
              resultAll.setText(String.valueOf(result));
          }
    ...
    if(from_type.equals("kg - كيلو جرام") ){
        if(to_type.equals("kg - كيلو جرام")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 / 1000;
            resultAll.setText(String.valueOf(result));
          }
            ...
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 2.20462262;
            resultAll.setText(String.valueOf(result));
          }
      }
    if(from_type.equals("mg - ملي جرام") ){
        if(to_type.equals("mg - ملي جرام")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
            ...
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 0.00000220462262;
            resultAll.setText(String.valueOf(result));
          }
      }
    if(from_type.equals("µg - ميكرو جرام ") ){
        if(to_type.equals("µg - ميكرو جرام ")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 0.00000000000110231131;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("kg - كيلو جرام")){
            num1= Double.parseDouble(txtAll.getText());
            ...
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 0.00000000220462262;
            resultAll.setText(String.valueOf(result));
          }
      }    
 if(from_type.equals("ng - نانو جرام") ){
        if(to_type.equals("ng - نانو جرام")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
    ...
    if(from_type.equals("pg - بيكو جرام") ){
        if(to_type.equals("pg - بيكو جرام")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
            ...
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 0.00000000000000220462262;
            resultAll.setText(String.valueOf(result));
          }
        
      } 
    if(from_type.equals("lb - بوند") ){
        if(to_type.equals("lb - بوند")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
            ...
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 0.45359237;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("g - جرام")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 453.59237;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("mg - ملي جرام")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 453592.37 ;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("µg - ميكرو جرام ")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 453592370;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("ng - نانو جرام")){
            num1= Double.parseDouble(txtAll.getText());
            result = num1 * 45359237;
            result = result * 10000;
            resultAll.setText(String.valueOf(result));
          }
        else if(to_type.equals("pg - بيكو جرام")){
    ...
    if(from_type.equals("g - جرام") ){
        if(to_type.equals("g - جرام")){
            num1= Double.parseDouble(txtAll.getText());
            resultAll.setText(String.valueOf(num1));
          }
        else if(to_type.equals("ton - طن")){
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ImageIcon icon = new ImageIcon("src/app icons/weight.png");
